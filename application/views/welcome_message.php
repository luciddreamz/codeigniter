...
<section class='container'>
        ...
        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Deploying code changes by victor</h2>
...
$ git push</pre>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
			  <section class="codeigniter">
				...
				<p>The page you are looking at is being generated dynamically by CodeIgniter. If you are exploring CodeIgniter for the very first time, you should start by reading the <a href="http://www.codeigniter.com/userguide3/">User Guide</a>.</p>
		...
		<div class="row">
			<section class="col-xs-12">
				<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development' || ENVIRONMENT === 'local') ?  'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?></p>
			</section>
        </div>
